...
#Example
eff8a <- urbin:::logitEffInt( allCoef = c( -2.5, 0.3, 0.5, -0.2, 0.03, 0.6 ), 
  allXVal = c( 1, NA, 0.12 ), 
  xPos = 2, 
  refBound = c( 8, 12 ), intBound = c( 13, 15 ),
  yCat = 2, model = "MNL" )
...
eff8b <- urbin:::logitEffInt( allCoef = c( -2.5, 0.3, 0.5, -0.2, 0.03, 0.6 ), 
  allXVal = c( 1, NA, 0.12 ), 
  xPos = 2, 
  refBound = c( 8, 12 ), intBound = c( 13, 15 ),
  yCat = 2, 
...
#Example
eff9a <- urbin:::logitEffInt( allCoef = c( 0.2, 0.03, 0.005, -0.2, 0.03, 0.006 ), 
  allXVal = c( 1, NA, NA ), 
  xPos = c( 2, 3 ), 
...
eff9b <- urbin:::logitEffInt( allCoef = c( 0.2, 0.03, 0.005, -0.2, 0.03, 0.006 ), 
  allXVal = c( 1, NA, NA ), 
  xPos = c( 2, 3 ), 
  refBound = c( 1, 12 ), intBound = c( 13, 25 ),
  yCat = 2, 
...
#Example
eff10a <- urbin:::logitEffInt( allCoef = c( 0.2, 0.03, 0.005, 0.091 ), 
...
eff10b <- urbin:::logitEffInt( allCoef = c( 0.2, 0.03, 0.005, 0.091 ), 
  allXVal = c( 1, NA, NA, 2.45, 1, NA, NA, 0.79 ), 
  xPos = c( 2, 3 ), 
  refBound = c( 1, 12 ), intBound = c( 13, 25 ),
